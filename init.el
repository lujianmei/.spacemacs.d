...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yasnippet-snippets yaml-mode web-mode solarized-theme sayid pyvenv pipenv persp-mode orgit org-mime org-download org-brain org-alert monokai-theme live-py-mode link-hint js2-refactor ibuffer-projectile hy-mode hl-todo helm-projectile helm-make helm-descbinds gitconfig-mode gitattributes-mode git-link evil-org evil-nerd-commenter evil-matchit evil-magit editorconfig dumb-jump dockerfile-mode docker counsel-projectile counsel swiper ivy company-web company-auctex company-ansible company-anaconda clj-refactor multiple-cursors auto-compile packed auctex avy cider clojure-mode lua-mode smartparens go-mode yasnippet gitignore-mode helm helm-core htmlize magit magit-popup git-commit ghub with-editor alert projectile js2-mode company slime spaceline powerline s dash which-key exec-path-from-shell async evil org-plus-contrib zenburn-theme yapfify xterm-color ws-butler winum web-completion-data web-beautify volatile-highlights vi-tilde-fringe uuidgen use-package unfill undo-tree toc-org tagedit tablist symon string-inflection sql-indent spaceline-all-the-icons smeargle slime-company slim-mode shell-pop scss-mode sass-mode reveal-in-osx-finder restart-emacs rainbow-delimiters queue pytest pyenv-mode py-isort pug-mode popwin plantuml-mode pippel pip-requirements pcre2el pbcopy password-generator paradox ox-twbs ox-gfm overseer osx-trash osx-dictionary org-super-agenda org-projectile org-present org-pomodoro org-bullets open-junk-file neotree nameless mwim multi-term mu4e-maildirs-extension mu4e-alert move-text mmm-mode markdown-toc magit-gitflow macrostep lorem-ipsum log4e livid-mode linum-relative less-css-mode launchctl json-mode js-doc jinja2-mode inflections indent-guide importmagic impatient-mode hungry-delete highlight-parentheses highlight-numbers highlight-indentation helm-xref helm-themes helm-swoop helm-pydoc helm-purpose helm-mu helm-mode-manager helm-gitignore helm-flx helm-css-scss helm-company helm-c-yasnippet helm-ag graphviz-dot-mode goto-chg google-translate golden-ratio godoctor go-tag go-rename go-guru go-eldoc gnuplot gntp git-timemachine git-messenger gh-md fuzzy font-lock+ flx-ido fill-column-indicator fancy-battery eyebrowse expand-region evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist evil-numbers evil-mc evil-lisp-state evil-lion evil-indent-plus evil-iedit-state evil-exchange evil-escape evil-ediff evil-cleverparens evil-args evil-anzu eshell-z eshell-prompt-extras esh-help emmet-mode elisp-slime-nav edn docker-tramp diminish cython-mode company-tern company-statistics company-lua company-go common-lisp-snippets column-enforce-mode coffee-mode cnfonts clojure-snippets clojure-cheatsheet clean-aindent-mode cider-eval-sexp-fu centered-cursor-mode auto-yasnippet auto-highlight-symbol ansible-doc ansible anaconda-mode aggressive-indent adaptive-wrap ace-window ace-link ace-jump-helm-line ac-ispell))))
(custom-set-faces
