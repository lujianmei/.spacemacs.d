...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (zenburn-theme solarized-theme org-brain meghanada evil-org ensime enh-ruby-mode editorconfig csv-mode ghub let-alist org-mac-link youdao-dictionary names chinese-word-at-point yaml-mode vimrc-mode unfill tabbar plantuml-mode peep-dired org-super-agenda org-category-capture org-bullets open-junk-file move-text macrostep lorem-ipsum linum-relative link-hint insert-shebang info+ indent-guide imenu-list ibuffer-projectile hungry-delete highlight-parentheses highlight-numbers parent-mode highlight-global hide-comnt help-fns+ helm-themes helm-swoop helm-mode-manager projectile helm-flx helm-descbinds helm-ag graphviz-dot-mode google-translate golden-ratio fuzzy flx-ido flx fill-column-indicator fancy-battery eyebrowse evil-visualstar evil-visual-mark-mode evil-tutor evil-surround evil-numbers evil-nerd-commenter evil-lisp-state evil-indent-plus evil-iedit-state iedit evil-escape evil-args evil-anzu anzu goto-chg emoji-cheat-sheet-plus elisp-slime-nav request-deferred tablist docker-tramp dash-at-point dactyl-mode company-emoji company-auctex column-enforce-mode cnfonts hydra clean-aindent-mode eval-sexp-fu pkg-info epl bind-map bind-key auto-highlight-symbol auto-compile packed f ace-jump-helm-line popup slime-company slime common-lisp-snippets clojure-snippets clj-refactor inflections edn paredit peg cider-eval-sexp-fu cider seq queue clojure-mode evil-matchit undo-tree highlight avy evil-ediff hl-todo helm-projectile websocket helm-dash fcitx deferred docker kotlin-mode expand-region evil-search-highlight-persist aggressive-indent ace-link dash evil-exchange neotree highlight-indentation helm-make fish-mode exec-path-from-shell evil-unimpaired evil-mc chinese-fonts-setup adaptive-wrap ace-window ace-isearch async s nginx-mode winum ein dumb-jump dockerfile-mode company-shell auctex smartparens evil helm helm-core diminish monokai-theme yapfify xterm-color web-mode web-beautify tagedit sql-indent smeargle slim-mode shell-pop scss-mode sass-mode rvm ruby-tools ruby-test-mode rubocop rspec-mode robe reveal-in-osx-finder rbenv rake pyvenv pytest pyenv-mode py-isort pug-mode pip-requirements pbcopy osx-trash osx-dictionary orgit org-projectile org-present org org-pomodoro org-download mwim multi-term mu4e-maildirs-extension mu4e-alert ht alert log4e gntp mmm-mode minitest markdown-toc markdown-mode magit-gitflow lua-mode livid-mode skewer-mode simple-httpd live-py-mode less-css-mode launchctl json-mode json-snatcher json-reformat js2-refactor multiple-cursors js2-mode js-doc intero hy-mode htmlize hlint-refactor hindent helm-pydoc helm-hoogle helm-gitignore helm-css-scss helm-company helm-c-yasnippet haskell-snippets haml-mode gnuplot gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe+ git-gutter-fringe fringe-helper git-gutter+ git-gutter gh-md flyspell-correct-helm flyspell-correct flycheck-pos-tip pos-tip flycheck-haskell flycheck evil-magit magit magit-popup git-commit with-editor eshell-z eshell-prompt-extras esh-help emmet-mode diff-hl cython-mode company-web web-completion-data company-tern dash-functional tern company-statistics company-ghci company-ghc ghc haskell-mode company-emacs-eclim eclim company-cabal company-anaconda company coffee-mode cmm-mode chruby bundler inf-ruby auto-yasnippet yasnippet auto-dictionary anaconda-mode pythonic ac-ispell auto-complete ws-butler window-numbering which-key volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline powerline restart-emacs request rainbow-delimiters popwin persp-mode pcre2el paradox spinner org-plus-contrib package-build spacemacs-theme))))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
