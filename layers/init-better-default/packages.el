...
(defconst init-better-defaults-packages
  '(
...
(defun init-better-defaults/post-init-recentf ()
  (progn
...
(defun init-better-defaults/init-dired-mode ()
  (use-package dired-mode
    ...
    (progn
      ...
      (evilified-state-evilify-map dired-mode-map
        :mode dired-mode
        :bindings
        (kbd "C-k") 'init/dired-up-directory
...
(defun init-better-defaults/init-profiler ()
